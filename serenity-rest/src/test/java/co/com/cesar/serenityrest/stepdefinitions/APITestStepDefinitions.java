...
import co.com.cesar.serenityrest.exceptions.NotMatchException;
 ...
 *      Serenity 3.0.5
 */
import co.com.cesar.serenityrest.tasks.Connect;
import co.com.cesar.serenityrest.tasks.UsingGetMethod;
import co.com.cesar.serenityrest.tasks.UsingPostMethod2;
import co.com.cesar.serenityrest.tasks.UsingPostMethod3;
...
public class APITestStepDefinitions {
    ...
    public void theServiceReturnTheData() {
        ...
        ACTOR.should(
                seeThat("status code", StatusCode.is(), Matchers.equalTo(STATUS_CODE_200)).orComplainWith(NotMatchException.class, "Status code does not match"),
